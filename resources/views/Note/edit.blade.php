...
<form class="" action="{{ route('Note.update',['id'=>$Note->NoteID]) }}" method="POST">
    @csrf
    <div class=" flex mb-6 mx-[50px] w-[500px] h-[100px] bg-gray-600 rounded-xl border-black border-2 ">
      <div class="">
        ...
        <input type="text" name="NoteName" value="{{ $Note->Name }}" id="Name" class="mx-5 rounded-lg" required>
      </div>
      <div class="">
      ...
      <textarea type="text" name="Description" id="Description" class="ml-10  bg-gray-50 resize-none border border-gray-300 text-gray-900 text-sm rounded-lg w-[1300px] h-[400px] " required>
        {{ $Note->Content }}
          ...
          {{-- <div class="mb-6">
            ...
            <input type="text" name="NoteName" value="{{ $Note->Name }}" id="Name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
          </div>
          <div class="mb-6">
